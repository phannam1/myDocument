		...
		<div class="container">
			<div class="row">
				<div class="col-md-12">
					<div class="aa-properties-content">
						...
						<div class="aa-properties-content-head1">
							<div class="aa-properties-content-head-left1">
								<form action="" class="aa-sort-form">
									<label style="font-size: 30px;">Câu Hỏi : 1+1 =?</label>
									<div>02/12/2017</div>
								</form>
				...
				<div class="col-md-12">
					<aside class="aa-properties-sidebar">
						...
						<div class="aa-properties-single-sidebar">
							<h3 style="text-align: center;">Các Câu trả lời khác </h3>
			...
			<div id="right_wrap">
				<div id="right_content">
					...
					<input  style="border: 1px solid #ccc !important;" class="submit_Forum" type="submit" value="Tìm kiếm">
			...
			<label style="margin-top: 10px;">Câu trả lời của bạn:<form action="#" method="post">
					...
					<div>
					<a href="<%=request.getContextPath()%>/forum"><i class="fa fa-arrow-left"  style=" float: right; font-size: 30px; padding-right: 20px;	" ></i></a>
					</div>
					</div>
					</aside>
				</div>
