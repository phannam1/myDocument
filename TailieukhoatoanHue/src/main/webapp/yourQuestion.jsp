							...
							<div class="col-md-6 col-sm-6 col-xs-6">
								<div class="aa-header-right">
									...
									<a id="show" href="<%=request.getContextPath()%>/Infor">
										...
										id="showAdmin" href="<%=request.getContextPath()%>/Logout">ADMIN</a>
						...
						<div class="aa-title">
							...
							<div>
								...
								<div style="text-align: left; padding-left: 10px;">
									<div class="menu">
										<ul>
											<li><a href="<%=request.getContextPath()%>/forum"
												style="size: 100px;">Các câu hỏi khác </a></li>

											<li><a href="yourQuestion.jsp" class="selected">Câu
													hỏi của bạn</a></li>
									...
									<div class="center_content">
										...
										<div id="right_wrap">
											<div id="right_content">
												...
												<div class="search_Forum">
													<form action="">
														<input class="input_Forum" type="text" value=""
															name="inputValueSearch"> <input
															class="submit_Forum" type="submit" value="Tìm kiếm">
												...
												<table id="rounded-corner">
													<thead>
														<tr>
															<th>STT</th>
															<th>Câu Hỏi(<i class="fa fa-question"></i>)
															</th>
															<th>Ngày Tháng(<i class="fa fa-clock-o"></i>)
															</th>
															<th>Sửa(<i class="fa fa-wrench"></i>)
															</th>
															<th>Xóa(<i class="fa fa-trash "></i>)
															</th>
														</tr>
													</thead>
													<tfoot>
													...
													<tbody>
														<tr class="odd">
															...
															<td>04/03/2019</td>
															<td><a href="#"><img src="img/edit.png" alt=""
																	title="" border="0" /></a></td>
										...
										<div id="tab1" class="tabcontent">
											...
											<form method="post" action="#">
												<div class="form">
													<div class="form_row">
														<label>Tài khoản của bạn:</label> <input type="text"
